...
package com.facultate.documentscannerandroid
...
import com.facultate.documentscanner.ImageCropActivity
import com.facultate.documentscanner.helpers.ScannerConstants
import com.facultate.documentscannerandroid.R
import java.io.File
...
class MainActivity : AppCompatActivity() {
    ...
    fun setView() {
        btnPick.setOnClickListener(View.OnClickListener {
            ...
            //builder.setTitle("")
            builder.setMessage("Alegeti sursa imaginii ")
            builder.setPositiveButton("Galerie") { dialog, which ->
                dialog.dismiss()
            ...
            builder.setNeutralButton("Iesire") { dialog, _ ->
                dialog.dismiss()
            }
